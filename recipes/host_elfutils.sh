...
CFLAGS="-Wno-error -I$SCRIPT_DIR/host_zlib/include" LDFLAGS="-L$SCRIPT_DIR/host_zlib/lib -Wl,-rpath=$SCRIPT_DIR/$RECIPE_NAME/lib -Wl,-rpath=$SCRIPT_DIR/host_zlib/lib"
