...
call "%root_dir%cc_elf.bat" %debug_flags% -S -o "%~1debug.%~2.elf.s" "%~1%~2.c" %FLAGS%
if %errorlevel% neq 0 exit /b
call "%root_dir%cc_elf.bat" %debug_flags% -o "%~1debug.%~2.elf" "%~1%~2.c" %FLAGS%
if %errorlevel% neq 0 exit /b
call "%root_dir%cc_elf.bat" %release_flags% -S -o "%~1%~2.elf.s" "%~1%~2.c" %FLAGS%
if %errorlevel% neq 0 exit /b
call "%root_dir%cc_elf.bat" %release_flags% -o "%~1%~2.elf" "%~1%~2.c" %FLAGS%
if %errorlevel% neq 0 exit /b
